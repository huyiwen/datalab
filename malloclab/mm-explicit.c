...
static void insertFreeBlock(void* ptrFreeBlock)
{
    ...
    if (ptrNextBlock != NULL)
        ((freeStruct*)ptrNextBlock)->pPrev = ptrFreeBlock;
...
static void requestMoreSpace(int reqSize)
{
    ...
    /* initialize footer*/
    *(int*)((char*)((char*)(ptrNewBlock) + totalSize) - 4) = totalSize | prevLastWordMask;
...
int mm_init(void)
{
    ...
    ptrFirstFreeBlock = (void*)mem_heap_lo() + 4;
...
void* mm_malloc(size_t size)
{
    ...
    if (blockSize - reqSize >= 16) {
        ...
        *(int*)((char*)((char*)ptrFreeBlock + blockSize) - 4) = ((blockSize - reqSize) | 0x2);
...
void* mm_realloc(void* ptr, size_t size)
{
    ...
    *(int*)((char*)((char*)newHeader + reqSize) - 4) = size;
    ...
    if (((*(int*)(oldHeader)) & 0x4) == 0) { /* already realloc block */
        ...
        copySize = currentPayloadSize; /* at maximum two word overhead*/
